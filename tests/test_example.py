...
class TestGrouping(unittest.TestCase):
    ...
    def test_nem12_data_daily(self):
        ...
        print(a[0])
        daily_summaries = qldtariffs.get_daily_usages(INTERVAL_READINGS, 'Ergon', 'T14')
    ...
    def test_nem12_data_monthly(self):
        ...
        month_summaries = qldtariffs.get_monthly_usages(INTERVAL_READINGS, 'Ergon', 'T14')
    ...
    def test_nem13_data(self):
        ...
        month_summaries = qldtariffs.get_monthly_usages(MANUAL_READINGS, 'Ergon', 'T11')
